...
game.party.splice(1, 0, pokemon[20], pokemon[50], pokemon[88])
...
for (gym of game.gyms) {
    if (this.gym.difficulty < 3) {
        this.gym.completed = true
    }
}
...
for (pokeParty of game.party) {
  console.log(pokeParty.name)
}
...
for (starterPoke of pokemon) {
  if (starterPoke.starter === true) {
    console.log(starterPoke.name)
  }
}
...
*/
game.catchPokemon = function(pokemonObj) { game.party.push(pokemonObj) }
